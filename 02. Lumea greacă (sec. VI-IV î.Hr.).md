...
<div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 15px; padding: 20px; margin: 20px 0; color: white;">
    <div style="display: flex; align-items: center; margin-bottom: 15px;">
        ...
        <div>
            <h3 style="margin: 0;">Podcast - Lumea greacă</h3>
            <p style="margin: 5px 0 0 0; opacity: 0.9; font-size: 0.9em;">Explorează civilizația greacă: ascensiunea și decăderea Polisului</p>
        </div>
    </div>
